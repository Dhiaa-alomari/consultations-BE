...
urlpatterns = [
    ...
    path('availability/',
         SlotAvailabilityView.as_view(), name='slot_availability'),
    ...
    path('my-appointments/',
         AppointmentHistoryView.as_view(), name='my_appointments'),

    # Admin-only
    path('categories/create/',
         CategoryAdminCreateView.as_view(), name='category_create'),
    path('categories/<int:pk>/',
         CategoryAdminDetailView.as_view(), name='category_detail'),
]
